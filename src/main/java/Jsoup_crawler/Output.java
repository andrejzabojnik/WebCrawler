...
public class Output {
    ...
    public static void text_output(Document doc, String url) {
        ...
        for (Element element : elements) {
            String[] processedText = NPL.textProcessing(Text_filter.text_filter(element.toString()));
            outputBuilder.append(String.join(" ", processedText)).append("\n");
        }
